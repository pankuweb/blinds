  ...
  return (
    <section>
      <div className="available_right_section">
        <h5 className="fw-normal mb-3 mt-3">3/8" Sheer Single Cell</h5>
      ...
      <div className="available_right_section">
        <h5 className="fw-normal mb-3 mt-3">3/4" Sheer Single Cell</h5>
        <div className="available_grid-column">
          <div className="col position-relative">
            <CardCommon
              imgsec="https://www.blinds.com/product-images/089d979b-7ceb-ea11-9482-0a986990730e.jpg?width=130&height=130&mode=crop&scale=both"
      ...
      <div className="available_right_section">
        <h5 className="fw-normal mb-3 mt-3">1 1/4" Sheer Single Cell</h5>
        <div className="available_grid-column">
          <div className="col position-relative">
            <CardCommon
              imgsec="https://www.blinds.com/product-images/089d979b-7ceb-ea11-9482-0a986990730e.jpg?width=130&height=130&mode=crop&scale=both"
