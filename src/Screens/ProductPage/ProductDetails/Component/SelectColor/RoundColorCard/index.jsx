const RoundColorCard = ({ colorImg, imgSrc, isActive, onClick }) => {
  return (
    <div
      className={`position-relative border-color ${isActive ? "active" : ""}`}
      onClick={onClick}
    >
      <img src={colorImg} className="rounded-circle" />
      <div className="container-swatch-zoom position-absolute top-0 end-0 mx-1 my-2">
        <svg
          stroke="currentColor"
          fill="#fff"
          strokeWidth="0"
